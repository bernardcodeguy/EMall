<%-- 
    Document   : allogin
    Created on : Sep 3, 2022, 2:47:15 PM
    Author     : Kornell
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%! 
    String title = "Log In Page";
    String username = "";
%>
...
<div class="container" id="reg-container"> 
		 <div class="card grey lighten-4">
		       <div class="card-content">	       
		       	...
		       	<form action="allogin" method="post">
		       	<div class="row center-align">
		       			...
		       			<div class="col s12">
		       				<div class=input-field>
		       					...
		       					<input type="text" id="username" class="validate" name="username"  value="<%= username%>" readonly>
