...
<% 
    ...
    if(session.getAttribute("username") == null){
        ...
        list=ProductDao.getRecords(pageid,total);  
...
<header>
    ...
    <!-- Cart count queries -->
     ...
     <!-- Cart sum queries -->
            <sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3307/emall" user="root" password="1234"/>
	    <sql:query var="rsct" dataSource="${db}">
	    SELECT * FROM product
	    </sql:query>
            
             <print:set var = "coun"  value = "${rsct.rowCount}"/> 
    ...
    <div class="container" style="margin-top:20px;">
        ...
        <div class="nav-wrapper">
            ...
            <div class="input-field">
              <input id="search" type="search" placeholder="Search product by name or category" name="keyword" required>
